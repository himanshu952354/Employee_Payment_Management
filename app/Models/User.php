...
#[Fillable(['name', 'email', 'password', 'role', 'company_name', 'employee_id', 'departments', 'currency', 'stripe_key', 'stripe_secret', 'paypal_client_id', 'paypal_client_secret', 'paypal_mode'])]
